...
interface RegisterProps {
    onLogin: () => void; // Function to switch to the login page
    onSuccess: (token: string, name: string) => void; // Function to handle successful registration
}
...
export default function Register({ onLogin, onSuccess }: RegisterProps) {
        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-500 via-indigo-600 to-cyan-500 flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="w-full max-w-md relative z-10">
                ...
                <div className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl p-8 border-2 border-white">
                    <h2 className="text-3xl font-extrabold text-center text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-600 mb-6">Create Account</h2>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            // Changed classes to match the blue/cyan gradient
                            className="w-full bg-gradient-to-r from-blue-600 to-cyan-600 text-white py-3 rounded-xl hover:from-blue-700 hover:to-cyan-700 transition-all shadow-lg hover:shadow-xl disabled:opacity-50 flex items-center justify-center gap-2"
                        >
                            {loading ? 'Processing...' : (
                    ...
                    <button
                        onClick={onLogin}
                        className="w-full bg-gradient-to-r from-blue-600 to-cyan-600 text-white py-3 rounded-xl hover:from-blue-700 hover:to-cyan-700 transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2"
                    >
